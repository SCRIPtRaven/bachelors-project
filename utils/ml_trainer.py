...
class MLRerouteTrainer:  
    ...
    def load_data(self) -> Tuple[pd.DataFrame, pd.DataFrame, pd.Series, pd.Series]:
        ...
        try:
            ...
            print(f"Split into {len(X_train)} training and {len(X_test)} testing samples (before undersampling)")
            ...
            if HAS_IMBLEARN:
                ...
                try:
                    ...
                    print(f"Could not apply undersampling: {e}. Continuing with original training data.")
            else:
