...
class MapWidget(LeafletMapWidget):
    ...
    def handle_js_driver_position(self, driver_id, lat, lon):
        ...
        if hasattr(self, 'disruption_viewmodel') and self.disruption_viewmodel:
            if hasattr(self.disruption_viewmodel, 'simulation_controller') and \
                ...
                # Call the update_driver_position method to check for nearby disruptions
    ...
    def handle_js_disruption_activated(self, disruption_id):
        ...
        print(f"Python received disruption activation for ID: {disruption_id}")  # Add debug print
        if self.messenger:
            print(f"Sending disruption activation message for ID: {disruption_id}")  # Add debug print
    ...
    def run_simulation(self):
        ...
        # First ensure the disruption viewmodel has access to the current solution
        ...
        # Explicitly pass the solution to the disruption viewmodel
        self.disruption_viewmodel.current_solution = self.optimization_viewmodel.current_solution
        print(
            f"Passed solution with {len(self.optimization_viewmodel.current_solution)} assignments to disruption viewmodel")

        # Now initialize simulation controller
        if hasattr(self.disruption_viewmodel, 'initialize_simulation_controller'):
            ...
            if success and self.disruption_viewmodel.simulation_controller:
                ...
                print("Successfully initialized and connected simulation controller")
            else:
                self.show_message("Error",
        ...
        # Now that everything is properly set up, start the simulation
