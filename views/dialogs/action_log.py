...
class ActionLogDialog(QtWidgets.QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.setFixedSize(600, 700)  # Larger size since it's a dedicated window
    ...
    def init_ui(self):
        ...
        self.log_text.setMinimumHeight(400)  # Taller text area
    ...
    def add_log_entry(self, message, entry_type="action"):
        ...
        html_color = "#000000"  # Default black
    ...
    def update_active_disruptions(self, disruptions):
        ...
        for disruption in disruptions:
            ...
            # Set item color based on disruption type
            ...
            elif disruption.type.value == 'vehicle_breakdown':
                item.setForeground(QtGui.QColor("#581845"))
